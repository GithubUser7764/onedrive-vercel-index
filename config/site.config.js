...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'oneindex@bailv.top',
  ...
  links: [
    {
      name: 'Site',
      link: 'https://hazukichan.top/',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/Yuzu_fujisawa',
    },
  ],
